...
::hud-grid
  ::hud-panel{title="Core Systems" status="nominal" icon="i-lucide-cpu"}
  ...
  ::hud-panel{title="Comms Array" status="nominal" icon="i-lucide-activity"}
...
::hud-grid
  ::hud-panel{title="Database Link" status="nominal" icon="i-lucide-database"}
  ...
  ::hud-panel{title="Security Sector" status="warning" icon="i-lucide-shield"}
